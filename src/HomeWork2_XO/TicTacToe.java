...
public class TicTacToe {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            do {
                ...
                if(listener.equals("X")) switchPlayers(names,scores);
            } while (listener.equals("failed")||listener.equals("X"));
    ...
    public static void menuOutput(int[] score, String[] names) {
        ...
        System.out.print("Enter [1] to start\t[X] to switch players\t[E] to exit\n\nYour choice: ");
    }//prints menu
    ...
    public static void turnOutput(int i, String[] names) {
        ...
        System.out.println("[A1] format to make turn, [Z] restarts game, [E] exits game.");
